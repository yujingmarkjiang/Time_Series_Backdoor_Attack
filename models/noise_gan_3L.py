...
class Classifier_Noise_GAN:
    ...
    def _fit_backdoor(self, backdoor_clf, x_train, y_train, x_test, y_test, y_target, y_test_classlabel,
        ...
        for e in range(1, 40):
            ...
            full_model.fit(x_train_backdoor, y_train_backdoor, batch_size=16, epochs=4)
            ...
            self.model.save_weights(self.output_directory + 'generator_save/' + \
                                    f'epoch{e}p_{val_clean_acc:.3f}_{val_ASR:.3f}_{val_ASR_train:.3f}.hdf5')
            ...
            backdoor_clf.fit(x_train, y_train, x_test, y_test, y_test_classlabel, nb_epochs=int(3*e**0.3))
